...
interactive_alzheimers_heatmap <- interactive_alzheimers_heatmap %>% 
  layout(
    title = list(
      text = paste0(
       "<b><span style = 'font-size:16px'>Heatmap of Death Rates from Alzeimers and other dementias across Europe 2000-2021</span></b><br>",
      "<b><span style='font-size:12px'>Countries ordered by mean death rate per 100,000</span></b>"), #manually adding the subtitle back into the graph as when i did it before it removed the subtitle 
